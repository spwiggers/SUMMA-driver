...
//Returns the various calibration data AS7261
float AS726X::getCalibrated_X() { return(getCalibratedValue(AS7261_X_CAL)); }
float AS726X::getCalibrated_Y() { return(getCalibratedValue(AS7261_Y_CAL)); }
float AS726X::getCalibrated_Z() { return(getCalibratedValue(AS7261_Z_CAL)); }
float AS726X::getCalibrated_x() { return(getCalibratedValue(AS7261_x_CAL)); }
float AS726X::getCalibrated_y() { return(getCalibratedValue(AS7261_y_CAL)); }
float AS726X::getCalibrated_upri() { return(getCalibratedValue(AS7261_upri_CAL)); }
float AS726X::getCalibrated_vpri() { return(getCalibratedValue(AS7261_vpri_CAL)); }
float AS726X::getCalibrated_u() { return(getCalibratedValue(AS7261_u_CAL)); }
float AS726X::getCalibrated_v() { return(getCalibratedValue(AS7261_v_CAL)); }
float AS726X::getCalibrated_duv() { return(getCalibratedValue(AS7261_duv_CAL)); }
float AS726X::getCalibrated_LUX() { return(getCalibratedValue(AS7261_LUX_CAL)); }
float AS726X::getCalibrated_CCT() { return(getCalibratedValue(AS7261_CCT_CAL)); }

float AS726X::getCalculated_CCT() { 

	float x = getCalibratedValue(AS7261_x_CAL);
	float y = getCalibratedValue(AS7261_y_CAL);
	float Xe = 0.3320;
	float Ye = 0.1858;
	float n = (x - Xe)/(Ye - y);
