...
public:
	...
	float getCalibrated_X();
	float getCalibrated_Y();
	float getCalibrated_Z();

	float getCalibrated_x();
	float getCalibrated_y();
	float getCalibrated_upri();
	float getCalibrated_vpri();
	float getCalibrated_u();
	float getCalibrated_v();

	float getCalibrated_duv();
	float getCalibrated_LUX();
	float getCalibrated_CCT();
	float getCalculated_CCT();
...
#define AS7261_x_CAL 0x20
#define AS7261_y_CAL 0x24
